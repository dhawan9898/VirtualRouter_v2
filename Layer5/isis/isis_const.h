...
#define ISIS_TLV_ON_DEMAND 111U

#define ISIS_HOLD_TIME_FACTOR 2U

#define ISIS_LSP_DEFAULT_FLOOD_INTERVAL  30
#define ISIS_LSP_DEFAULT_LIFE_TIME_INTERVAL (ISIS_LSP_DEFAULT_FLOOD_INTERVAL * 2U)

/* Reconciliation Constants*/
#define ISIS_DEFAULT_RECONCILIATION_THRESHOLD_TIME 10U 
#define ISIS_DEFAULT_RECONCILIATION_FLOOD_INTERVAL 2U

/* Bit position of Flags in LSP pkt isis_lsp_pkt_t->lsp_gen_flags */
#define ISIS_LSP_F_PURGE_LSP   0
#define ISIS_LSP_F_OVERLOAD    1
